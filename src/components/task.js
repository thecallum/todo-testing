  ...
  return (
    <li className="tasklist-item">
      <div className="tasklist-item-left">
        ...
        />
        <span className={`tasklist-item-value ${task.completed && 'completed'}`}>{task.value}</span>
      ...
      <button className="tasklist-item-button" onClick={handleDeleteTask} aria-label="Delete task" />
    </li>
  );
}
